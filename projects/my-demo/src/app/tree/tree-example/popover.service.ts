...
import { IccPortalContent } from 'icc';
import { IccPortalComponent } from 'icc';
import { IccOverlayConfig } from 'icc';
import { IccOverlayService } from 'icc';
import {
...
export class IccPopoverService implements OnInit, OnDestroy {
  ...
  popoverType: 'hover' | 'click' | 'contextmenu' | 'disabled' = 'contextmenu';
  popoverLevel = 0;
